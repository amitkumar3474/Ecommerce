                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">User Form</p>

                                    <form class="mx-1 mx-md-4" action="{{ route('user.store')}}" method="post"  enctype="multipart/form-data">
                                      @csrf
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <label class="form-label" for="form3Example4cd">Roles</label>
                                                ...
                                                <div>
                                                    <input type="checkbox" id="<?=$_role->name?>" class="f" name="roles[]" value="<?=$_role->name?>"/>
